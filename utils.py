...
def PrelimPlots(dat, lab):
    ...
    ax.plot(dat[mask0,9]+0.5*shift2[mask0],dat[mask0,2],'o',label='deceased',markersize=msV,c='b')
    ax.plot(dat[~mask0,9]+0.5*shift2[~mask0],dat[~mask0,2],'o',label='survived',markersize=msV,c='g')
    ax.set_ylabel(r"Age",fontsize=fs)
